...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterVH> {
    ...
    private List<Stories> mSliderItems = new ArrayList<>();
    private String Doc_Id;
    FirebaseFirestore db = FirebaseFirestore.getInstance();


    // constructor for our adapter class.
    public SliderAdapter(Context context, List<Stories> mSliderItems) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_row, null);
...
//        viewHolder.stories.setText(sliderItem.getDoc_ID());
    ...
    class SliderAdapterVH extends SliderViewAdapter.ViewHolder {
        ...
        public SliderAdapterVH(View itemView) {
            ...
            headline = itemView.findViewById(R.id.slider_title);

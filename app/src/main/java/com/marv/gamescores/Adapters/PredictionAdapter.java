...
public class PredictionAdapter extends FirestoreRecyclerAdapter<Stories, PredictionAdapter.StoriesViewHolder> {
    ...
    public PredictionAdapter(@NonNull FirestoreRecyclerOptions<Stories> options) {
        super(options);
    }
